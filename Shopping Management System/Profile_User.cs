            ...
            else
            {
                ...
                if (count == 0)
                {
                    if (date_ischanged == true)
                    {
                        ...
                        param[3].Value = dateTime_expire_panel_add.Value;

                        param[4] = new SqlParameter("@date_of_production", SqlDbType.Date);
                        param[4].Value = dateTime_production_panel_add.Value;
                    ...
                    else
                    {
                        ...
                        if (pic_product_add == true)
                        {
                            ...
                            param[7].Value = img_location_add_product;
                        }
        ...
        private void button_updateproduct_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (date_ischanged_update == true)
                {
                    ...
                    SqlCommand cmd = new SqlCommand("select ID from Category where Name ='" + comboBox_catname_updateprod.SelectedItem + "'", con); ;
                    int id_cat = Convert.ToInt32(cmd.ExecuteScalar());
                ...
                else
                {
                    ...
                    SqlCommand cmd = new SqlCommand("select ID from Category where Name ='" + comboBox_catname_updateprod.SelectedIndex + "'", con); ;
                    int id_cat = Convert.ToInt32(cmd.ExecuteScalar());
